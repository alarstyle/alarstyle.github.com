(function(d, e)
{
        ...
        var n = function(b, c, a, f)
            {
                ...
                var h, i, e, j, p, w = !0,
                    ...
                    r = [],
                    u = b;
                do if(g.exec(""), h = g.exec(u)) if(u = h[3], r.push(h[1]), h[2])
                {
                    j = h[3];
                    break
                }
    ...
    c.extend(
    {
        ...
        {
            var f = b && typeof b === "object" ? c.extend(
            {}, b) : {
        ...
        var c = this._keyboard = {
            ...
            o = this._lightbox = {
                ...
                show: function(c)
                {
                    ...
                    {}, a._keyboard.map), a.attachKeyboard(
                    {
                        escape: o.hide,
                        right: o.showNext,
                        left: o.showPrev
    ...
    var E = [],
        t = d.G = {
            ...
            run: function(d, q, t)
            {
                ...
                {};
                l.theme = E[d];
                l.utils.loadCSS("css/1.css", "galleria-theme", function()
                {
                    e(q).galleria(
                    {
                        responsive: !0,
    ...
    G.make(0, {
        ...
        init: function(e)
        {
            ...
            e._showTooltip && this.bindTooltip(
            {
                fullscreen: function()
                {
                    return l.isFullscreen() ? t.exit_fullscreen : t.enter_fullscreen
                },
                play: function()
                {
